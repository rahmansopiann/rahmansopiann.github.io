    ...
    <footer id="contact" className="py-24 bg-page-bg border-t border-white/5">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
          <div>
            <span className="text-xs font-bold uppercase tracking-[0.3em] text-accent mb-6 block">Ready to collaborate?</span>
            <h2 className="font-display text-5xl md:text-7xl font-bold tracking-tight mb-8">
              Let's build <br /> <span className="text-accent italic">something great.</span>
            </h2>
          ...
          <div className="flex flex-col gap-12">
            <div className="grid grid-cols-2 gap-8">
              ...
              <div>
                <h4 className="text-xs font-bold uppercase tracking-widest text-white/40 mb-6">Site</h4>
                <div className="flex flex-col gap-4 text-sm font-medium">
        ...
        <div className="mt-32 pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-sm text-white/40 italic">
            &copy; {currentYear} Rahman Sopian. All rights reserved.
          </p>
